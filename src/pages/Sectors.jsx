...
import sectorHero from "../assets/sector.png"
const sectors = [
  {
...
export default function Sectors({ go, hash }) {
  ...
  return (
    <div data-screen-label="Sectors">
      {/* Hero */}
      <section style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", padding: "120px clamp(20px,4vw,56px) 60px", overflow: "hidden", backgroundImage: `linear-gradient(rgba(25, 25, 25, 0.74), rgba(25, 25, 25, 0.21)), url(${sectorHero})`, backgroundSize: "cover", backgroundPosition: "center" }}>
