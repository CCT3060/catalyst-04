  ...
  return (
    <div data-screen-label="Solutions">
      <section style={{position:"relative",background:"#191919",padding:"170px clamp(20px,4vw,56px) clamp(70px,8vw,110px)",overflow:"hidden"}}>
        <div style={{position:"absolute",inset:0,background:"radial-gradient(55% 60% at 80% 15%,rgba(3,115,255,.22),transparent 60%),radial-gradient(55% 60% at 10% 95%,rgba(67,147,74,.2),transparent 60%)"}}></div>
        ...
        <div style={{position:"relative",maxWidth:1240,margin:"0 auto"}}>
          <div data-reveal className="shown" style={{display:"inline-flex",alignItems:"center",gap:8,fontFamily:"Caveat, cursive",color:"#0373ff",fontWeight:600,fontSize:24,letterSpacing:"0",marginBottom:22}}><span style={{width:26,height:2,background:"#0373ff"}}></span>Solutions</div>
        ...
        <div style={{maxWidth:1240,margin:"0 auto"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(6,1fr)",gap:20,marginTop:60}} data-3col>
            <div data-reveal onClick={() => go("food")} className="lift" style={{gridColumn:"span 4",position:"relative",minHeight:300,borderRadius:32,overflow:"hidden",background:"linear-gradient(135deg,#191919,#242424)",padding:36,display:"flex",flexDirection:"column",justifyContent:"space-between",cursor:"pointer"}}>
              <div style={{position:"absolute",inset:0,background:"radial-gradient(60% 70% at 85% 20%,rgba(3,115,255,.3),transparent 60%)"}}></div>
              ...
              <div style={{position:"relative"}}>
                ...
                <span style={{display:"inline-flex",alignItems:"center",gap:6,marginTop:16,color:"#0373ff",fontWeight:600,fontSize:14}}>Explore <ArrowRight size={16} /></span>
              </div>
            </div>
            ...
            <div data-reveal data-delay="1" onClick={() => go("ifm")} className="lift" style={{gridColumn:"span 2",position:"relative",minHeight:300,borderRadius:32,overflow:"hidden",background:"linear-gradient(135deg,#242424,#2E2E2E)",padding:30,display:"flex",flexDirection:"column",justifyContent:"space-between",cursor:"pointer"}}>
              ...
              <div style={{position:"relative"}}>
                ...
                <span style={{display:"inline-flex",alignItems:"center",gap:6,marginTop:14,color:"#0373ff",fontWeight:600,fontSize:14}}>Explore <ArrowRight size={16} /></span>
              </div>
            </div>
            ...
            <div data-reveal data-delay="2" onClick={() => go("workforce")} className="lift" style={{gridColumn:"span 2",position:"relative",minHeight:300,borderRadius:32,overflow:"hidden",background:"linear-gradient(135deg,#191919,#242424)",padding:30,display:"flex",flexDirection:"column",justifyContent:"space-between",cursor:"pointer"}}>
              <div style={{position:"absolute",inset:0,background:"radial-gradient(70% 70% at 50% 20%,rgba(3,115,255,.28),transparent 60%)"}}></div>
              <div style={{position:"relative",display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
                <div style={{width:48,height:48,borderRadius:16,background:"rgba(3,115,255,0.2)",display:"flex",alignItems:"center",justifyContent:"center",color:"#0373ff"}}>
                  <Users size={24} />
                </div>
